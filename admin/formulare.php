...
<body class="bg-bg-light text-gray-900">
        ...
        <main id="mainContent" class="flex-1 lg:ml-72 transition-all duration-300">
            <header class="sticky top-0 z-10 bg-white/80 backdrop-blur-md border-b border-gray-200 px-4 lg:px-8 h-16 flex items-center justify-between">
                <div class="flex items-center gap-4">
                    ...
                    <h2 class="text-lg font-bold text-gray-900">Formulare</h2>
                </div>
            ...
            <div class="p-4 lg:p-8 max-w-6xl mx-auto space-y-6">
                <div class="flex items-start justify-between gap-3">
                    <div>
                        <h1 class="text-2xl lg:text-3xl font-black text-gray-900 tracking-tight">Formular-Builder</h1>
                        <p class="text-gray-500 mt-1">Dynamische Formulare inklusive Felder, Signatur, Uploads und E-Mail-Weiterleitung verwalten.</p>
                    </div>
                    <a href="formular-editor.php" class="bg-primary text-white px-4 py-2.5 rounded-lg text-sm font-bold flex items-center gap-2 hover:bg-primary-dark transition-all shadow-sm shadow-primary/20 whitespace-nowrap">
                        ...
                        <table class="w-full text-left border-collapse">
                            <thead>
                                <tr class="bg-bg-light/50">
                                    <th class="px-6 py-3 text-xs font-bold text-gray-500 uppercase tracking-wider">Formular</th>
                                    <th class="px-6 py-3 text-xs font-bold text-gray-500 uppercase tracking-wider">Slug</th>
                                    <th class="px-6 py-3 text-xs font-bold text-gray-500 uppercase tracking-wider">Direktlink</th>
                                    <th class="px-6 py-3 text-xs font-bold text-gray-500 uppercase tracking-wider">Einsendungen</th>
                                    <th class="px-6 py-3 text-xs font-bold text-gray-500 uppercase tracking-wider">Status</th>
                                    <th class="px-6 py-3 text-xs font-bold text-gray-500 uppercase tracking-wider">Aktualisiert</th>
                                    <th class="px-6 py-3 text-xs font-bold text-gray-500 uppercase tracking-wider text-right">Aktion</th>
                                </tr>
                            </thead>
                            <tbody id="formsTableBody" class="divide-y divide-gray-100">
    ...
    <script src="js/formulare.js?v=20260816-2"></script>
</body>
</html>
